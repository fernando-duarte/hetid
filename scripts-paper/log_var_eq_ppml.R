...
# Plan 7 estimator constructor, and the editorial panel-order rule. The core
...
source("scripts-paper/log_var_eq_ppml_fit.R")
...
# The Plan 7 estimator object. At construction it fits the scale anchor once
