# The bespoke SLSQP epigraph solver for the joint log-variance GMM compatibility-search
# (joint-GMM, logvar-joint-gmm, dossier section 6.2). The exact minimax
...
# from finite probes. Definitions only; sourced by epigraph.R.
