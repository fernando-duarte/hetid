# The stacked log/PPML moment layer for the joint log-variance system (joint-GMM,
...
# rank diagnostic those Jacobians share, and the graph-replication design rank
...
# graph-replication design precondition: normalize each nonzero column of x_mat by its
