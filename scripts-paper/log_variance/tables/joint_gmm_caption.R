...
# compatibility diagnostic (joint-GMM, logvar-joint-gmm). Mirrors the joint-null
# note: the byte-identity gate excludes exactly this block and the per-tau numbers
# live in the CSV and RDS artifacts. Appended by render_panels.R, which
# reaches this builder through run.R. The wording carries no
