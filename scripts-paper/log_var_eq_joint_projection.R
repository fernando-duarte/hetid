# Ratification-gated Stage C projection for the joint moment-compatibility layer
# (Plan 4, logvar-joint-gmm). Definitions only. Without a ratified moment_delta
...
# Sourced by test_logvar_joint_gmm.R and the Stage B/C driver.
