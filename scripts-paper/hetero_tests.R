...
# E[(Z - EZ) Var_t(Y2)]; its diagonal is the Cov(Z, Y2^2) row. det, condition
# number, and smallest singular value gauge whether Z moves the news
...
notes <- c(
  ...
  "$\\mathrm{Cov}(Z,Y_{2,i}Y_{2,j})$. Joint relevance is directional.",
