# Representation-stable residualized-z basis for the joint moment-compatibility layer
# (Plan 4, logvar-joint-gmm, Option A). Residualize z on the static variance regressors
...
# Definitions only; sourced by test_logvar_joint_gmm.R and the Stage A driver.
