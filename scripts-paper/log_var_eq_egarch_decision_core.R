# Base-R decision core for the gated EGARCH-X extension (Plan 5, Task 3): the
...
# are chain-sourced from log_var_eq_egarch_route_core.R below. Definitions only;
# sourced by scripts-paper/logvar_egarch_decision.R, by the route driver, and by
...
LOGVAR_EGARCH_GATE_RECORD_PATH <-
  "scripts-paper/output/log_var_eq_dynamics_gate.rds"
...
# themselves are content of the committed record, log_var_eq -> file 3); pinning
...
source("scripts-paper/log_var_eq_egarch_route_core.R")
