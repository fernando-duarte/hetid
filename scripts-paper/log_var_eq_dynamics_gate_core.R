# Base-R residual-dynamics gate for the log-variance equation (Plan 5, Task 2).
...
# log_var_eq_dynamics_gate.R at pipeline time and by the offline gate test.
#
...
source("scripts-paper/log_var_eq_dynamics_gate_record.R")
