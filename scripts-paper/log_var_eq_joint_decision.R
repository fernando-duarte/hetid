# Pure decision-record helpers for the joint moment-compatibility gate (Plan 4,
...
# (mirrors logvar_sample_id). Sourced by scripts-paper/logvar_joint_gmm_decision.R
