...
# evaluated analytically by set_id_region_common.R.
# Writes set_id_region_3d.pdf to scripts-paper/output/.

local({
  source("scripts-paper/set_id_region_3d_helpers.R", local = TRUE)
  source("scripts-paper/set_id_region_3d_drawing.R", local = TRUE)
  ...
  grDevices::cairo_pdf(
    filename = file.path(out_dir, "set_id_region_3d.pdf"),
    width = 9.6,
    height = 8.4,
    family = "DejaVu Sans"
  )
...
cat("set_id_region_3d: wrote", file.path(out_dir, "set_id_region_3d.pdf"), "\n")
