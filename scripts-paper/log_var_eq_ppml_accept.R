...
# log_var_eq_ppml_fit.R to keep both files under the hard 200-line cap. Defines
...
# by log_var_eq_ppml_fit.R before logvar_ppml_fit_response; definitions only.

# Complete fit-result skeleton: every field the Plan 7 fit contract names is
