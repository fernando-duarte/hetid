...
# log-variance QMLE standard errors. The PPML (log_var_eq_ppml_se.R) and Harvey
# (log_var_eq_harvey_se.R) modules keep only their variance math -- the bread,
...
# attach-time console diagnostic. Sourced by run_all.R before both *_se.R
# modules. Drops the estimator token like log_var_eq_table_utils.R and
# log_var_eq_engine*.R. Definitions only.
