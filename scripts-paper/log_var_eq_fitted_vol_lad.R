...
# baseline mean-equation slack, the analog of log_var_eq_fitted_vol.R's PPML and
...
# Reuses logvar_fitted_vol_data / _render / _path. Run via run_all.R after
# log_var_eq_fitted_vol.R.

source("scripts-paper/log_var_eq_fitted_vol_envelope.R")
source("scripts-paper/log_var_eq_fitted_vol_plot.R")
