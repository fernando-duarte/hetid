...
.artifact_producers <- c(
  ...
  p = "inference/run_bootstrap_stage.R",
...
.artifact_specs <- c(
  ...
  "heteroskedasticity_w2_table|hetero_tests_w2.tex|2|b|B|r",
  "heteroskedasticity_w2_standalone_tex|hetero_tests_w2_standalone.tex|2|b|B|r",
  "heteroskedasticity_w2_standalone_pdf|hetero_tests_w2_standalone.pdf|2|b|B|r",
  ...
  "log_var_eq_harvey_inference_table|log_var_eq_harvey_inference.tex|2|ad|B|r",
  "log_var_eq_harvey_inference_standalone_tex|log_var_eq_harvey_inference_standalone.tex|2|ad|B|r",
  "log_var_eq_harvey_inference_standalone_pdf|log_var_eq_harvey_inference_standalone.pdf|2|ad|B|r",
  "log_var_eq_logols_inference_table|log_var_eq_logols_inference.tex|2|ad|B|r",
  "log_var_eq_logols_inference_standalone_tex|log_var_eq_logols_inference_standalone.tex|2|ad|B|r",
  "log_var_eq_logols_inference_standalone_pdf|log_var_eq_logols_inference_standalone.pdf|2|ad|B|r",
