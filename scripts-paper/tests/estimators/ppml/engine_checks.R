# Set-map checks for the PPML estimator over the shared engine: singleton-set
...
# and the start-pool / grid_selector seam refinements. The shared
# peng_* fixtures defined here are reused by table_checks.R (sourced after this
# file). Sourced by test_ppml.R. Feature-dependent checks run
# through peng_try so a missing implementation fails cleanly rather
