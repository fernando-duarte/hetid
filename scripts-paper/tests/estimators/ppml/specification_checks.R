...
# (scripts-paper/log_variance/estimators/ppml/estimator.R). The canonical spec_id must separate
...
# fit_checks.R to keep both files under the hard 200-line cap. Each assertion is
# failure-guarded so a missing required estimator module fails closed.
