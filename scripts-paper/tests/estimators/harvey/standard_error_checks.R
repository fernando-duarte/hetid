...
# from the Harvey standard-error module: the five covariance variants against
...
# guards, and the SE-frame shape. Mirrors the PPML standard-error checks; reuses
# harvey_fx. The observed information itself is already checked against a
# finite-difference Hessian in objective_checks.R.
