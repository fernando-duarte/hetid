# Graph-replication profile-layer checks (companion to moment_checks.R, split to
...
# test_joint_gmm.R after the moment checks; it owns check(), jg_try, jg_need, and
# the jg_fx fixtures. Every check asserts the required symbol exists first, so an
