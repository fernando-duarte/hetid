...
suite_manifest <- data.frame(
  id = c(
    ...
    "residual_diagnostics", "residual_diagnostics_contracts",
    "covariance_adapter", "set_bootstrap", "bootstrap_stage", "bootstrap_stage_cache",
  ...
  path = c(
    ...
    "figures/fitted_volatility/test_tau_sweep.R",
    "figures/residual_diagnostics/test_residual_diagnostics.R",
    "figures/residual_diagnostics/test_contracts.R",
    "inference/test_covariance_adapter.R",
    "inference/test_set_bootstrap.R",
    "inference/test_bootstrap_stage.R",
    "inference/test_bootstrap_stage_cache.R",
    "inference/test_bootstrap_stage_pipeline.R",
    "inference/bootstrap_stage_anchor_condition_checks.R",
    "inference/bootstrap_stage_eval_spec_ssot_checks.R",
    "inference/bootstrap_stage_indexed_draw_contract_checks.R",
    "inference/bootstrap_stage_spec_contract_checks.R",
    "inference/endpoint_targets_checks.R",
    "inference/manifest_tier_checks.R",
