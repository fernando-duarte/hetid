# Offline tri-state reader for the quantreg dependency gate that Plan 3 (the LAD
# median map) consumes. It parses the Debian-control decision record, validates
