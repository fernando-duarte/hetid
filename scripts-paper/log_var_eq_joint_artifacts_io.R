...
# (Plan 4, logvar-joint-gmm). Definitions only, sourced by
# log_var_eq_joint_artifacts.R: the flat typed frame assembled from the fixed
...
# identical() round trip and the CSV agreement before it returns. Mirrors Plan
# 6's honest-artifact idiom so the flat machine-readable view and the bit-exact
