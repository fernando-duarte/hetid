...
# via run_all.R after log_var_eq_ppml_sets.R, before log_var_eq_ppml_table.R.

source("scripts-paper/log_var_eq_harvey.R")
source("scripts-paper/log_var_eq_harvey_driver_helpers.R")
...
# same warm-refined boxes over a fresh cache and budget, applied through Plan 1's
