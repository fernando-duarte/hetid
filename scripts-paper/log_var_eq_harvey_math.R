...
# condition (exactly minus twice the score, so Plan 4 can stack it against
...
# log_var_eq_harvey_solver.R and log_var_eq_harvey.R before the response solve,
...
# score, exposed with the FOC sign so Plan 4 stacks Harvey against PPML's
...
# Jacobian, the rcond gate, and Plan 4.
