...
build_logvar_notes <- function() {
  ...
  c(
    ...
    "sound tests (per-observation linear-functional bounds over the set, and",
    "residual sign flips across the feasible grid); a found crossing is",
    "certain, while a no-crossing verdict shares the local-solver caveat of",
    "every reported bound. Each crossing at observation $t$ drives",
