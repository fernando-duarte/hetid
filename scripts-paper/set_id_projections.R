...
# (see set_id_region_common.R). The box is taken from the SAME contour geometry
...
# Run via run_all.R after set_id_mean_eq.R and set_id_region_common.R.
...
local({
  ...
  grDevices::pdf(file.path(out_dir, "set_id_projections_sd.pdf"),
    width = 11, height = 4.7
  )
...
cat(
  "set_id_projections: wrote", file.path(out_dir, "set_id_projections_sd.pdf"),
  "\n"
)
