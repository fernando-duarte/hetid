...
if (!exists(".lad_domain_geom")) {
  source(if (requireNamespace("here", quietly = TRUE)) {
    here::here("scripts-paper/log_var_eq_lad_domain_witness.R")
  } else {
    "scripts-paper/log_var_eq_lad_domain_witness.R"
  })
}
if (!exists("logvar_lad_tail_classify")) {
  source(if (requireNamespace("here", quietly = TRUE)) {
    here::here("scripts-paper/log_var_eq_lad_domain_tail.R")
  } else {
    "scripts-paper/log_var_eq_lad_domain_tail.R"
  })
}
