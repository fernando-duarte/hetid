...
# lives in log_var_eq_ppml_coverage.R, sourced below to keep both files under the
# hard 200-line cap. Definitions only; sourced after log_var_eq_ppml.R (for
# logvar_ppml_fit) and the engine, before the driver log_var_eq_ppml_sets.R.

source("scripts-paper/log_var_eq_ppml_coverage.R")
