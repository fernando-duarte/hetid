...
### 📊 Data Management
- **ACM Term Structure Data**: Monthly yields, term premia, and risk-neutral yields at one-month maturity steps from 6 to 120 months
...
selected on one temporal block and the set is evaluated on the other,
so the evaluated bound uses weights fixed relative to the evaluation
sample. Even there, validity is conditional on the maintained bound
holding at the selected weights, and serial dependence across the
block boundary makes the conditioning approximate; uniform
post-selection inference over the admissibility class is out of scope.
