...
\file{scripts-paper/validation/regen_egarch_decision.R} entrypoint, because the
...
\file{scripts-paper/validation/regen_egarch_decision.R} &
Separate entrypoint &
\code{Rscript} \code{scripts-paper/validation/regen_egarch_decision.R} reads the
...
carries no instrument identifier of its own. It lives under \file{validation/}
because the source-topology gate admits exactly two entrypoints directly under
\file{scripts-paper/} and exempts \file{validation/}. The runner never calls it.\\
...
entrypoint \file{scripts-paper/validation/regen_egarch_decision.R}, because that
