...
tally over these 50 records is 43 \code{required}, three \code{conditional_lad},
and four \code{conditional_egarch}; the 34 generated records are all
\code{required}, which is how the manifest reaches 77 required of 84.

Five of the 84 records have no producer that resolves them. Four are the EGARCH
