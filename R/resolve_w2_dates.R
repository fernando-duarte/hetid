#' Resolve the \eqn{\omega_2} Realization-Date Index from Full-T Input Dates
#'
#' The \eqn{\omega_2} residual \eqn{\omega_{2,t+1}} is a one-step news object realized at
...
#' \eqn{d_2, \ldots, d_T} (length \code{nrow(yields) - 1}, the \eqn{\omega_2} news count).
...
#'
#' @return The \eqn{t+1} realization \code{Date} index of the \eqn{\omega_2} observations,
