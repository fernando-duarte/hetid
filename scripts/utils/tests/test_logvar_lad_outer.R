...
# (log_var_eq_lad.R, log_var_eq_lad_refine.R, log_var_eq_lad_sets.R) over the
# Plan 7 engine. Standalone entry point; RED until Tasks 3-4. Pure engine/seam
# anchors ride on a dummy estimator and pass; LAD-estimator checks fail closed.
# Assumed names (Task 3 freezes them): logvar_lad_estimator(w1, w2, pcr, qtr) ->
# Plan 7 object (fit_at_b, analyze_domain precheck/sides/claim_failure, no
...
lad_modules <- c(
  "scripts-paper/log_var_eq_lad.R", "scripts-paper/log_var_eq_lad_fit.R",
  "scripts-paper/log_var_eq_lad_domain.R", "scripts-paper/log_var_eq_lad_refine.R",
  "scripts-paper/log_var_eq_lad_sets.R"
)
