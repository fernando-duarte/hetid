...
# (log_var_eq_joint_null*.R). Entry point mirroring test_logvar_harvey.R: source
# the map/engine/log-OLS/polish and joint-null layers (red until Task 3), define
...
#   Rscript scripts/utils/tests/test_logvar_joint_null_helpers.R
...
source(here::here("scripts-paper/log_var_eq_polish.R"))

# The joint-null modules do not exist yet; source only what is present so the
# suite runs to completion with module-dependent checks failing closed.
jn_modules <- c(
  "scripts-paper/log_var_eq_joint_null_inputs.R",
  "scripts-paper/log_var_eq_joint_null_math.R",
  "scripts-paper/log_var_eq_joint_null_search.R",
  "scripts-paper/log_var_eq_joint_null_stability.R",
  "scripts-paper/log_var_eq_joint_null.R"
)
for (f in jn_modules) if (file.exists(here::here(f))) source(here::here(f))
...
# Fail a check closed when a not-yet-defined joint-null function errors.
...
source(here::here("scripts/utils/tests/test_logvar_joint_null_crossing.R"))
source(here::here("scripts/utils/tests/test_logvar_joint_null_pipeline.R"))
