...
# of the joint log-variance GMM (Plan 4, logvar-joint-gmm, dossier section 6.2).
# This script is deliberately not wired into the committed entry point
# test_logvar_joint_gmm.R: it exercises the disabled Stage-B solver branch on
...
# empirical inputs. Sources the committed Stage-A modules and the new Stage-B
# modules, then runs its own check() harness. Run from the worktree root:
#   Rscript scripts/utils/tests/test_logvar_joint_gmm_solver.R

source(here::here("scripts-paper/log_var_eq_moments.R"))
source(here::here("scripts-paper/log_var_eq_joint_basis.R"))
source(here::here("scripts-paper/log_var_eq_joint_profiles.R"))
source(here::here("scripts-paper/log_var_eq_joint_identity.R"))
source(here::here("scripts-paper/log_var_eq_joint_candidates.R"))
source(here::here("scripts-paper/log_var_eq_joint_budget.R"))
source(here::here("scripts-paper/log_var_eq_joint_epigraph.R"))
