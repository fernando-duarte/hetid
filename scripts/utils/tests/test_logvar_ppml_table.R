...
# fixed editorial baseline tau = 0.05 (Task 6). The coverage block pins the
# space-filling grid_selector path the coverage gate uses: the as_selected
# large-grid bypass (Task 4 seam), the Morton coverage selector
# (logvar_ppml_morton_select, Task 5), and the figure plot-data canonicalizer.
# Sourced by test_logvar_ppml.R after test_logvar_ppml_engine.R, whose peng_*
...
# Morton coverage selector (Task 5): exact count, permutation invariance, an
