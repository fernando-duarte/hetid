...
# log-variance response fit (scripts-paper/log_var_eq_ppml_fit.R) and its b
# wrapper (scripts-paper/log_var_eq_ppml.R). Poisson and quasi-Poisson agree on
...
# Gaussian-scale intercept identity holds. RED tests: the PPML modules do not
...
# and defines check(); the identity/spec_id block lives in test_logvar_ppml_spec.
...
# Return FALSE instead of aborting when a not-yet-defined PPML function errors.
