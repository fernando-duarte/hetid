...
# (scripts-paper/log_var_eq_ppml_se.R): the covariance variants pinned against
...
# Sourced by test_logvar_ppml.R after test_logvar_ppml_table.R; reuses ppml_fx
# and the ptbl_* fixtures defined there.

# lag count emulating run_all.R's logvar_ppml_se_hac_lags; sandwich is a
