...
# Plan 7 engine (scripts-paper/log_var_eq_engine.R with log_var_eq_harvey.R):
...
# RED tests: the Harvey module does not exist yet, so every estimator-dependent
# assertion runs through he_try and fails closed rather than aborting. Sourced by
# test_logvar_harvey.R after the fixtures and the check() definition.
