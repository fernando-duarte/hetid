# Deterministic offline fixtures for the joint moment-compatibility layer (Plan 4,
...
# as the environment jg_fx; sourced by test_logvar_joint_gmm.R before the check files.
