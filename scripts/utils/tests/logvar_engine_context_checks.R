...
# engine (scripts-paper/log_var_eq_engine.R). Red tests -- the engine does not
# exist yet, so nothing here runs until Task 4 lands. They pin the Plan 7 seam
...
# test_logvar_engine.R (defines check(), sources the engine); this file adds neither.
...
# closure counter, implementing the Plan 7 contract fields; opts toggle the
