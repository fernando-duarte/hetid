...
# log-variance estimator (log_var_eq_lad_domain.R; the guard in
# log_var_eq_lad_fit.R). Standalone entry point; RED until Task 3. The oracles
...
lad_modules <- c(
  ...
  "scripts-paper/log_var_eq_lad_domain.R"
)
