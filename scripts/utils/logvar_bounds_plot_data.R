# Canonical plot-data builder for the log-variance bounds-by-tau figures:
# a pure function turning an estimator's per-tau schema tables and legacy
# set tables into one versioned, fixed-type, deterministically ordered
# object. It is the primary figure-regression artifact -- PDF bytes can
# drift with renderer metadata while this object must stay exactly equal.
# Definitions only; sourced by baselines, tests, and the figure driver.
