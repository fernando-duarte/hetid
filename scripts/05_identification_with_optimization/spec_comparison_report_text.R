...
build_spec_summary_lines <- function(grid, cov, bl, agg, suffix) {
  ...
  c(
    ...
    wrap(paste(
      ...
      "Each result cell is one specification: a bond-maturity subset, a",
      "number of",
    ...
    "  temp: spec_comparison_<profile>.csv  raw grid, <profile> = full or quick",
    ...
    "  stratum    a bond-maturity component-subset (widths comparable only within)",
    ...
    "  gamma       weighting scheme: vfci, optimized, separate",
